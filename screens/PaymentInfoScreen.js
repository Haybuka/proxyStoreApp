      ...
      <ScrollView>
        <View className="mt-6">
          <View className="w-20 h-20 mx-auto">
            <Image resizeMode='cover' className="w-full h-full" source={require("../assets/icon/utilities/Electricity/Ikeja.png")} />
          </View>
          <Text className="text-center font-semibold my-3 text-lg">Ikeja Electric</Text>
        </View>
        <View>
